package com.quicker.views;

import com.quicker.R;
import com.quicker.tools.TextDrawable;
...
public class CategoryTabStrip2 extends HorizontalScrollView {
	...
	public CategoryTabStrip2(Context context) {
		this(context, null);
	}

	public CategoryTabStrip2(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public CategoryTabStrip2(Context context, AttributeSet attrs, int defStyle) {
	...
	private void addTab(final int position, String title) {
		ViewGroup tab = (ViewGroup)mLayoutInflater.inflate(R.layout.category_tab2, this, false);
