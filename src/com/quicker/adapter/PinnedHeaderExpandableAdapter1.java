...
import com.quicker.views.PinnedHeaderExpandableListView.HeaderAdapter;

public class PinnedHeaderExpandableAdapter1 extends  BaseExpandableListAdapter implements HeaderAdapter{
	...
	public PinnedHeaderExpandableAdapter1(String[][] childrenData,String[] groupData
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (isExpanded) {
			iv.setImageResource(R.drawable.btn_browser1);
		}
		else{
	...
	private View createChildrenView() {
		return inflater.inflate(R.layout.child1, null);
	}
